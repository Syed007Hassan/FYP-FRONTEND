...
// create a footer by using tailwindcss which will have grid with rows and column. first colum will display the name of software and second, third column will display the links to the pages.
