      ...
      <div className="grid grid-rows-1 grid-flow-col">
        ...
        <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          <div className="grid grid-cols-3 gap-4 mb-4">
            <div className="flex items-center justify-center h-96 w-96 rounded bg-gray-50 dark:bg-gray-800">
              <Chart1 />
            </div>
            <div className="flex items-center justify-center h-95 w-96 rounded bg-gray-50 dark:bg-gray-800"></div>
