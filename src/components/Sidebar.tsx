        ...
        <ul className="space-y-2 font-medium">
          <li>
            ...
            >
              ...
              <span className="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-white-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                Pro
              </span>
            </a>
          </li>
          ...
          >
            <svg
              ...
              className={`w-6 h-6 fill-current text-white ${isOpen ? "hidden" : ""
                }`}
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
