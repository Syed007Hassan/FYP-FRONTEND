    ...
    >
      <div className="container mx-auto flex justify-between bg-blue-900 items-center h-10">
        <Link href="/" legacyBehavior className="py-3">
          <a>
            <Image src="/synnc.png" alt="Logo" width={100} height={62} />{" "}
            {/* Replace with your logo image path */}
          </a>
        </Link>
        <div className="text-center flex-grow px-10">
          {" "}
          {/* Use flex-grow to push items to the center */}
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <a
              href="/login"
              className="hover:text-gray-200 cursor-pointer border border-gray-300 px-6 py-3 rounded-full  hover:bg-blue-600"
            >
              Sign In
            </a>
          </div>
          <div className="hidden lg:flex items-center space-x-4">
            <a
              href="/demo"
              className="text-white rounded-full py-3 px-6 border border-gray-300 font-semibold hover:bg-blue-600"
            >
              Request a demo
            </a>
          </div>
