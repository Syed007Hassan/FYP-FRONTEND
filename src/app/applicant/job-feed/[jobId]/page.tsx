              ...
              <div className="grid grid-cols-12 gap-y-10 lg:gap-10">
                <div className="col-span-12 lg:col-span-8">
                  <div className="border border-dark rounded-md border-gray-100/30 dark:border-neutral-600/80">
                    ...
                    <div className="p-6 border-2 border-gray">
                ...
                <div className="col-span-12 space-y-6 lg:col-span-4 border-2">
                  <div className="border-2 rounded border-gray-100/30 dark:border-neutral-600/80">
                    <div className="p-6">
                      ...
                      <div className="mt-8 flex gap-5">
                        ...
                        >
                          <i className="fas fa-bookmark"></i> Show Stages
                        </Link>
